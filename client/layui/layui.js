...
gather.modules = {
  ...
  ,socket: 'lib/socket' //WebSocket库（第三方）
  ,jquery: 'lib/jquery' //DOM库（第三方）
  ,layout: 'modules/layout' //布局（大框架、Tab选项卡、固定块、侧边栏、面包屑）
  ,layer: 'modules/layer' //弹层
  ,laydate: 'modules/laydate' //日期
  ,layim: 'modules/layim' //web通讯
  ,tree: 'modules/tree' //树结构
  ,slide: 'modules/slide' //轮播
  ,color: 'modules/color' //颜色选择器
  ,editor: 'modules/editor' //富文本编辑器
  ,table: 'modules/table' //富表格
  ,flow: 'modules/flow' //流加载（图片延迟、瀑布流、信息流）
  ,util: 'modules/util' //工具集
  ,form: 'modules/form' //表单（验证、密码强度、下拉选择、输入选择、多选框）
  ,code: 'modules/code' //代码修饰器
  ,upload: 'modules/upload' //上传
  ,webupload: 'modules/webupload' //webuploader上传
  ,single: 'modules/single' //单页应用
  ,mobile: 'modules/mobile' //移动模块
};
